          ...
          <dd>
            ...
            <div id="panel4" class="content" style="background: #d7f1c2">
              ...
              <div class="large-12 columns">
                ...
                <div class="row">
                  <div class="large-2 columns">
                    <label class="left inline" for="video_1_title">Title:</label>
                  </div>
                  <div class="large-10 columns">
                    <input type="text" id="video_1_title" name="video_1_title"placeholder="Video 1 Title" />
                  </div>
                </div>
                <div class="row">
                  <div class="large-2 columns">
                ...
                <div class="row">
                  <div class="large-2 columns">
                    <label class="left inline" for="video_2_title">Title:</label>
                  </div>
                  <div class="large-10 columns">
                    <input type="text" id="video_2_title" name="video_2_title"placeholder="Video 2 Title" />
                  </div>
                </div>
                <div class="row">
                  <div class="large-2 columns">
                ...
                <div class="row">
                  <div class="large-2 columns">
                    <label class="left inline" for="video_3_title">Title:</label>
                  </div>
                  <div class="large-10 columns">
                    <input type="text" id="video_3_title" name="video_3_title"placeholder="Video 1 Title" />
                  </div>
                </div>
                <div class="row">
                  <div class="large-2 columns">
