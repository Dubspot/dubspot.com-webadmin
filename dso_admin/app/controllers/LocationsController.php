...
class LocationsController extends BaseController {
	...
	public function index()
	{
		...
		return View::make('scaffolds.locations.index', compact('locations'));
	}
	...
	{
		return View::make('scaffolds.locations.create');
	}
	...
	public function show($id)
	{
		...
		return View::make('scaffolds.locations.show', compact('location'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('scaffolds.locations.edit', compact('location'));
	}
