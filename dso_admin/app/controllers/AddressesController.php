...
class AddressesController extends BaseController {
	...
	public function index()
	{
		...
		return View::make('scaffolds.addresses.index', compact('addresses'));
	}
	...
	{
		return View::make('scaffolds.addresses.create');
	}
	...
	public function show($id)
	{
		...
		return View::make('scaffolds.addresses.show', compact('address'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('scaffolds.addresses.edit', compact('address'));
	}
