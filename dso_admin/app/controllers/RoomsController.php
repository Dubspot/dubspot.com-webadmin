...
class RoomsController extends BaseController {
	...
	public function index()
	{
		...
		return View::make('scaffolds.rooms.index', compact('rooms'));
	}
	...
	{
		return View::make('scaffolds.rooms.create');
	}
	...
	public function show($id)
	{
		...
		return View::make('scaffolds.rooms.show', compact('room'));
	}
	...
	public function edit($id)
	{
		...
		return View::make('scaffolds.rooms.edit', compact('room'));
	}
