...
<h1>Edit Scheduled_payment</h1>
{{ Form::model($scheduled_payment, array('method' => 'PATCH', 'route' => array('scheduled_payments.update', $scheduled_payment->id))) }}
	<ul>
        <li>
		...
		<li>
			...
			{{ link_to_route('scheduled_payments.show', 'Cancel', $scheduled_payment->id, array('class' => 'btn')) }}
		</li>
	</ul>
{{ Form::close() }}
