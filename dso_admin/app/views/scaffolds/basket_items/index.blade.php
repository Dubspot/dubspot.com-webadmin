...
<h1>All Basket_items</h1>

<p>{{ link_to_route('basket_items.create', 'Add new basket_item') }}</p>
...
@if ($basket_items->count())
	<table class="table table-striped table-bordered">
		...
		<tbody>
          ...
          <td>{{ link_to_route('basket_items.show', 'Show', array($basket_item->id), array('class' => 'btn btn-info')) }}</td>
