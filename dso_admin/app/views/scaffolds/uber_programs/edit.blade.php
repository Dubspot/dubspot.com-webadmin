...
<h1>Edit Uber_program</h1>
{{ Form::model($uber_program, array('method' => 'PATCH', 'route' => array('uber_programs.update', $uber_program->id))) }}
	<ul>
        <li>
		...
		<li>
			...
			{{ link_to_route('uber_programs.show', 'Cancel', $uber_program->id, array('class' => 'btn')) }}
		</li>
	</ul>
{{ Form::close() }}
