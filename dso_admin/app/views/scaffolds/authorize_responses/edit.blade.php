...
<h1>Edit Authorize_response</h1>
{{ Form::model($authorize_response, array('method' => 'PATCH', 'route' => array('authorize_responses.update', $authorize_response->id))) }}
	<ul>
        <li>
        ...
        <li>
            ...
            {{ Form::input('number', 'payment_id') }}
        </li>

		<li>
			{{ Form::submit('Update', array('class' => 'btn btn-info')) }}
			{{ link_to_route('authorize_responses.show', 'Cancel', $authorize_response->id, array('class' => 'btn')) }}
		</li>
	</ul>
{{ Form::close() }}
