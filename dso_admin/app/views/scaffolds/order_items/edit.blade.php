...
<h1>Edit Order_item</h1>
{{ Form::model($order_item, array('method' => 'PATCH', 'route' => array('order_items.update', $order_item->id))) }}
	<ul>
        <li>
		...
		<li>
			...
			{{ link_to_route('order_items.show', 'Cancel', $order_item->id, array('class' => 'btn')) }}
		</li>
	</ul>
{{ Form::close() }}
